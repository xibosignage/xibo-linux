...
RegionsParser::RegionsParser(const xml_node& regionNode) :
    m_regionNode(regionNode)
{
}

RegionOptions RegionsParser::parse()
{
    ...
    return RegionOptions{id, width, height, left, top, zindex, loop};
}
