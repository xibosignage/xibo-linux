...
const std::vector<UriTest> validHttpUris = {
    ...
    {"https://username@127.0.0.1/testtarget",
     Uri::Scheme::HTTPS,
     "127.0.0.1",
     443,
     "/testtarget",
    ...
    {"https://127.0.0.1:12/testtarget",
     Uri::Scheme::HTTPS,
     "127.0.0.1",
     12,
     "/testtarget",
     Uri::Authority::HostType::IP},
    {"https://127.0.0.1:123/testtarget",
     Uri::Scheme::HTTPS,
     "127.0.0.1",
     123,
     "/testtarget",
     Uri::Authority::HostType::IP},
    {"https://127.0.0.1:1234/testtarget",
     Uri::Scheme::HTTPS,
     "127.0.0.1",
     1234,
     "/testtarget",
     Uri::Authority::HostType::IP},
    {"https://127.0.0.1:12345/testtarget",
     Uri::Scheme::HTTPS,
     "127.0.0.1",
     12345,
     "/testtarget",
    ...
    {"https://username@www.example.com:1234/",
     Uri::Scheme::HTTPS,
     "www.example.com",
     1234,
     "/",
