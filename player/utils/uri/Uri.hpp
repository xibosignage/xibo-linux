...
public:    
    ...
    public:
        ...
        Authority(boost::optional<std::string> optionalUserInfo, const std::string& host, boost::optional<unsigned short> optionalPort);
        Authority(const std::string& host);

        boost::optional<std::string> optionalUserInfo() const;
