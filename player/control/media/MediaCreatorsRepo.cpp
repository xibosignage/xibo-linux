...
{
    add({XlfResources::Media::ImageType, XlfResources::Media::NativeRender}, std::make_unique<ImageParser>(), std::make_unique<ImageFactory>());
    add({XlfResources::Media::VideoType, XlfResources::Media::NativeRender}, std::make_unique<VideoParser>(), std::make_unique<VideoFactory>());
    ...
    add({XlfResources::Media::WebpageType, XlfResources::Media::NativeRender}, std::make_unique<WebViewParser>(), std::make_unique<WebViewFactory>());
    add({XlfResources::Media::DatasetViewType, XlfResources::Media::NativeRender}, std::make_unique<WebViewParser>(), std::make_unique<WebViewFactory>());
